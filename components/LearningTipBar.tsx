...
const LearningTipBar: React.FC = () => {
  ...
  return (
    <div className="bg-navy-900/70 border-b border-t border-navy-800">
        <div className="container mx-auto flex items-center justify-center text-center p-3">
            <div className="flex items-center space-x-3 text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-yellow-300 flex-shrink-0">
                ...
                <p className="text-navy-300">
                    <span className="font-semibold text-cyan-400 mr-1">Study Tip:</span>
